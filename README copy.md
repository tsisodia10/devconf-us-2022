...
11. Create routes for prometheus and alertmanager
- add name(alertmanager or prometheus), service name(blue-prometheus/alertmanager) and port(9090/9093)
...
13. Install Grafana operator

14. Create grafana instance
```
